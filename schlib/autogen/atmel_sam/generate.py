...
class SamModel(object):
    ...
    def _arrangePins(self):
        ...
        for pin in rightSide:
            ...
            expanded = "/".join( self.expandPortPin(pin[1]) + [pin[1]] )
    ...
    def getPackage(self):
        ...
        pinCode, packageCode = self.partNumber[6], self.partNumber[11]
    ...
    def expandPortPin(self, pin):
        "Takes port pin (eg 'PA15'), returns list of strings of port functions"
    ...
    def outputDcm(self):
        ...
        out = "#\n"
        out += "$CMP " + self.partNumber + "\n"
    
        brief = [
                self.getPackage(),
                self.getFlashString() + " Flash",
                self.getRamString() + " RAM",
                self.getSpeedString(),
